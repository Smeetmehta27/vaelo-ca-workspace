    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-50">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-sm border border-gray-200">
        ...
        <form className="flex flex-col gap-5">
          ...
          <button formAction={signup} className="w-full bg-slate-900 text-white py-2 px-4 rounded-md shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors sm:text-sm font-medium">Sign Up</button>
        </form>
