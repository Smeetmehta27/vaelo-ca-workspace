    ...
    <div className="flex h-screen w-full items-center justify-center bg-paper">
      <div className="w-full max-w-md bg-paper p-8 rounded-lg shadow-sm border border-stone-line flex flex-col items-center">
        ...
        <form className="flex flex-col gap-5 w-full">
          ...
          <button formAction={signup} className="w-full bg-bronze text-paper py-2.5 px-4 rounded-xl shadow-sm hover:bg-bronze-deep focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bronze transition-colors sm:text-sm font-medium">Sign Up</button>
        </form>
